...
module Pushr
  ...
  class Application
    ...
    def deploy!(force=false)
      ...
      @cap_output  = %x[cd #{path}/shared/cached-copy; BUNDLE_GEMFILE=#{path}/shared/cached-copy/Gemfile bundle install && BUNDLE_GEMFILE=#{path}/shared/cached-copy/Gemfile bundle exec cap #{cap_command} 2>&1]
      @success     = $?.success?
